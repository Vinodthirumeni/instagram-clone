...
CREATE PROJECT : npx create-react-app instagram-clone
...
DATABASE & DEPLOYMENT
	...
	> Enable firebase authentication to login via email in Firebase UI
	> create firebase authentication (email enable)
	> firebase login
	> firebase init
